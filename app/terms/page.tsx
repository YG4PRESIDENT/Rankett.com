        ...
        <div className="w-full">
          ...
          <div className="space-y-6 text-slate-300">
            <div className="bg-slate-900/50 border border-slate-800 p-4 rounded-md">
              <p className="font-semibold text-white">Effective Date: November 1, 2025</p>
              <p className="text-sm mt-1 text-slate-400">Last Updated: November 1, 2025</p>
            </div>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">1. Contracting Entity</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">3. Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">4. Account Registration</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">5. Free AI Visibility Report</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">6. Subscriptions, Fees, and Payment</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">7. API Access</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">8. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">10. Service Availability & Beta Features</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">11. Data & Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">12. AI Accuracy Disclaimer</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">13. Aggregated Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">14. Termination</h2>
              <ul className="list-disc ml-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">16. DMCA & IP Infringement</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">17. Confidentiality</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">18. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">19. Force Majeure</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">20. Assignment</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">21. Marketing Use</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">22. Entire Agreement & Severability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">23. Governing Law & Venue</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">24. Changes</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-3">25. Contact</h2>
              <p>
                📩 <a href="mailto:info@rankett.com" className="text-blue-400 hover:underline">info@rankett.com</a>
              </p>
            </section>
          </div>
          </div>
